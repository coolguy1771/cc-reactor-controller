...
local branchCases = {
  {name="ceiling", rpm=2001, steer=false, target={rfTarget=1,flowTarget=1,rpmLimit=2400}, steam=true},
  ...
  {name="legacy-coil", rpm=1800, steer=true, target=nil, coil=true},
}
for _, c in ipairs(branchCases) do
  ...
  local ccfg={}; for k,v in pairs(cfg) do ccfg[k]=v end; ccfg.flywheelMode=c.fly
